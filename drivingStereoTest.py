...
# Get image list
path = "2018-10-30-13-45-14_2018-10-30-13-54-03-518"
left_images = glob.glob('./images/left/'+path+'.jpg')
left_images.sort()
right_images = glob.glob('./images/right/'+path+'.jpg')
right_images.sort()
depth_images = glob.glob('./images/depth/'+path+'.png')
depth_images.sort()
